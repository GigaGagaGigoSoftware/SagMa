...
public class ChatController {
	...
	private void initialize() {
		...
		handleUserListReply(new UserListReplyPacket());
		System.out.println("messagePane: " + messagePane.getWidth());
...
//		messagePane.getChildren().clear();
	...
	private void handleUserListReply(UserListReplyPacket reply) {
		...
		userTreeItem.getChildren().add(new TreeItem<String>("Test2"));
		userTreeItem.getChildren().add(new TreeItem<String>("Test3"));
		userTreeItem.getChildren().add(new TreeItem<String>("Test4"));
	...
	public static class ActiveChatCell extends HBox {
		...
		ActiveChatCell(String partner, Button button) {
			super();
			this.button = button;
			this.button.getStyleClass().add("deleteButton");
