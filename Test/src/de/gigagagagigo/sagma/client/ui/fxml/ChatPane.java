...
public class ChatPane extends Pane{
	...
	public ChatPane(String partner, String username, AnchorPane messagePane) {
		...
		appendOwnMessage("hallo");
		appendMessage("test", "jo was geht ab dies sollte ein langer text werden also machen wir ihn mal etwas länger um das verhalten bei sehr langem text zu sehen vielleicht bemerken wir ja etwas");
